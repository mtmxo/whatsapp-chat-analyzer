...
def _chat():
    return Chat([
        Message(datetime(2024, 6, 12, 21, 35), "Mario", "ciao", MessageType.TEXT),
        Message(datetime(2024, 6, 12, 21, 36), None, "crittografati", MessageType.SYSTEM),
...
def test_csv_has_header_and_rows():
    ...
    assert len(rows) == 4  # header + 3 messaggi
